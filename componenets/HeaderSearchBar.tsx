...
import { searchState } from "../componenets/searchState"; //atom
  ...
  const handleClick = () => {
    Router.push({
      ...
      query: {
        ...
        startDate: JSON.stringify(date.map((d) => format(d.startDate, "yyyy-MM-dd"))),
  ...
  return (
    <>
      <div className={`flex  xl:flex-row flex-col  gap-4  `}>
        <div id="dist" className="flex  items-center border-2 bg-white  rounded-lg  p-2  ">
          <MdPlace></MdPlace>
          <input
            type="text "
          ...
          {openOptions && (
            <div className="flex flex-col shadow-lg  p-2 absolute top-14  bg-white  items-center ">
              <div className="   text-gray-500 p-2   flex  gap-3 shadow-sm">
                ...
                <button className="border-2 border-blue-400 w-7 font-bold" onClick={() => handleOption("adult", "i")}>
                  +
                </button>
              </div>
              ...
              <div className="   text-gray-500 p-2   flex  gap-3 ">
                ...
                <button className="border-2  border-blue-400 w-7 font-bold" onClick={() => handleOption("room", "i")}>
                  +
                </button>
              </div>
            </div>
        ...
        <button id="search" className="bg-white p-2 rounded-lg text-blue-600 " onClick={() => handleClick()}>
          Search
        </button>
      </div>
    </>
