...
const commonSteps: Step[] = [
  ...
  },
  {
    ...
    content:
      "Market Stats: Show all market details related to the selected pair and respective graphic",
  },
  /*   {
  ...
  },
  {
    target: ".market-fills",
    content:
      "Market History: Shows most recent market fills for the current active pair.",
  },
  {
    target: ".orderhistory",
    content:
...
export const marketPlaceSteps: Step[] = [
    ...
    },*/
  {
    ...
    content:
      "Check all related blockchain notifications here from market buy, market sell and token transfers.",
  },
];
